...
Создание новой ветки необходимо для разраьотки определенной версии исходного кода. Для создания новой ветки используется команда:

    git branch <branch_name>

## Слияние веток

Слияние веток необходимо для того, чтобы привести две разные версии исходного кода к единому знаменателю. Для того чтобы выполнить слияние веток необходимо перейти на ветку в которую будет происходить слияние и выполнить команду:
